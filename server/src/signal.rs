...
// Windows signal handling - uses Ctrl+C for shutdown, no equivalents for other Unix signals
#[cfg(windows)]
mod platform {
    use tracing::info;
    ...
    /// No equivalent on Windows - this future never completes
    pub async fn sigusr1_dump_config() {
...
pub(super) use platform::shutdown;
pub(super) use platform::sighup_compact;
pub(super) use platform::sigusr1_dump_config;
pub(super) use platform::sigusr2_tokio_dump;
