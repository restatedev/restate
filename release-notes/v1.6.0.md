...
- **Managed Kafka services**: Connect to Confluent Cloud, Azure Event Hubs, and other providers that support standard OAuth 2.0/OIDC token endpoints. **Note**: AWS MSK IAM authentication is not currently supported, as it uses a proprietary SigV4-based mechanism rather than standard OIDC. For MSK, use SASL/SCRAM authentication instead.
