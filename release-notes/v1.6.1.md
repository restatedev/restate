...
**Note**: This is the only additional `OTEL_*` variable now supported. Other OpenTelemetry environment variables remain ignored — use Restate's own configuration for those.
...
- **DataFusion updated to 52.1.0**: The SQL query engine has been updated to the latest version. ([#4333](https://github.com/restatedev/restate/pull/4333))
