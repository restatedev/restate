...
restatectl provision --disable-feature unscoped-idempotent-service-bucketing
# or comma-separated / repeated
restatectl provision --disable-feature unscoped-idempotent-service-bucketing,other-feature
```
