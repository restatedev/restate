...
The new settings let operators tune RocksDB file I/O and compaction behavior for their storage devices and workloads. Deriving write-buffer sizing from the available memory budget keeps the configured memtable budget and target SST size aligned.
