...
media_types:add("application/vnd.restate.invocation.v7", p_service_protocol)
streaming_media_types:add("application/vnd.restate.invocation.v7", p_service_protocol)
