...
impl<S, Y> PartialEq<Y> for RestrictedValue<S>
where
    S: StringLike + PartialEq<Y>,
    Y: StringLike,
{
...
impl<S, Y> PartialOrd<Y> for RestrictedValue<S>
where
    S: StringLike + PartialOrd<Y>,
    Y: StringLike + PartialEq<S>,
{
...
impl<S: StringLike> PartialOrd<str> for RestrictedValue<S> {
