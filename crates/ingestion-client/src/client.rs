    ...
    V: StorageEncode,
{
    ...
    pub fn ingest(
        ...
        self.ensure_enough_permits(size);
        ...
        let acquire = self.permits.clone().acquire_many_owned(size as u32);
...
pin_project_lite::pin_project! {
    ...
    #[project=IngestFutureStateProj]
    enum IngestFutureState {
        Error{err: Option<IngestionError>},
        AwaitingPermit {
...
mod test {
    ...
    use crate::{CommitError, IngestionClient, SessionOptions, client::InputRecord};
