...
use restate_pb::grpc::reflection::v1::server_reflection_request::MessageRequest;
use restate_pb::grpc::reflection::v1::server_reflection_response::MessageResponse;
use restate_pb::grpc::reflection::v1::server_reflection_server::*;
use restate_pb::grpc::reflection::v1::*;
        ...
        MessageRequest::ListServices(_) => {
            ...
            MessageResponse::ListServicesResponse(ListServiceResponse {
                service: proto_symbols
                    .list_services()
                    .into_iter()
                    .map(|svc| restate_pb::grpc::reflection::v1::ServiceResponse { name: svc })
                    .collect(),
            })
        }
    })
