    ...
    T: RpcMessage,
{
    ...
    /// Handle a message through this response tracker. If no request in flight exists for this message,
    /// then the owned message will be returned back to the caller.
