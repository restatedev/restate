...
#[openapi(
    ...
    external_docs(url = "https://docs.restate.dev/operate/"),
    tags(
        (name = "deployment", description = "Service Deployment management"),
        (name = "invocation", description = "Invocation management",
         external_docs(url = "https://docs.restate.dev/operate/invocation")),
        (name = "subscription", description = "Subscription management",
         external_docs(url = "https://docs.restate.dev/operate/invocation#managing-kafka-subscriptions")),
        ...
        (name = "storage", description = "Storage query"),
    ),
