...
use restate_types::replicated_loglet::{
    LocationScope, NodeSet, ReplicatedLogletId, ReplicatedLogletParams, ReplicationProperty,
};
...
impl<'a> NodeSetSelector<'a> {
    fn new<'b: 'a>(
        nodes_config: &'b NodesConfiguration,
        cluster_state: &'b ObservedClusterState,
    ) -> NodeSetSelector<'a> {
        Self {
            nodes_config,
            cluster_state,
...
mod tests {
    ...
    use restate_types::nodes_config::{LogServerConfig, NodeConfig, Role, StorageState};
