...
// fn logserver_writeable_node_filter(_node_id: PlainNodeId, config: &NodeConfig) -> bool {
//     matches!(
//         config.log_server_config.storage_state,
...
fn logserver_writeable_node_filter<'a>(
    observed_cluster_state: &'a ObservedClusterState,
) -> impl Fn(PlainNodeId, &NodeConfig) -> bool + 'a {
