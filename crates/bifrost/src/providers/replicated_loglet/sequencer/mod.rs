...
use futures::Stream;
use node::{LogletStatus, NodeClient, NodeSet, SpreadSelect, Tracker};
use tokio::sync::{mpsc, oneshot};
use worker::{Batch, Payload, WorkerEvent};
...
mod test {
    ...
    use super::{
        node::{NodeClient, SelectorAll, SelectorSimpleQuorum, SpreadSelect},
