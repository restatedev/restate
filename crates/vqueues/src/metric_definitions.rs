...
pub const VQUEUE_INVOKER_CAPACITY_WAIT: &str =
    "restate.vqueue.scheduler.invoker_capacity_exhausted_ms.total";
...
pub fn describe_metrics() {
    ...
    describe_counter!(
        VQUEUE_INVOKER_CAPACITY_WAIT,
        Unit::Milliseconds,
        "Cumulative number of milliseconds the scheduler has been waiting for invoker concurrency capacity"
    );
}
