...
mod tests {
    ...
    use restate_storage_api::vqueue_table::{
        EntryId, EntryKey, EntryMetadata, EntryStatistics, EntryValue, Stage, WriteVQueueTable,
    };
    ...
    fn test_entry_at(id: u8, has_lock: bool, run_at: MillisSinceEpoch) -> (EntryKey, EntryValue) {
        let key = EntryKey::new(has_lock, run_at, id as u64);
    ...
    async fn insert_entries(
        ...
        for (key, value) in entries {
            txn.put_inbox_entry(qid, stage, key, value);
        }
