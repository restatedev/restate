...
pub struct AdminOptions {
    ...
    pub heartbeat_interval: NonZeroDurationString,
    ...
    log_trim_check_interval: DurationString,
    ...
    pub storage_accounting_update_interval: Option<NonZeroDurationString>,
}
...
impl AdminOptions {
    ...
    pub fn log_trim_check_interval(&self) -> Option<Duration> {
        self.log_trim_check_interval.to_non_zero()
    }
...
impl Default for AdminOptions {
    fn default() -> Self {
        Self {
            ...
            heartbeat_interval: DurationString::new_unchecked(Duration::from_millis(1500)),
            // check whether we can trim logs every hour
            log_trim_check_interval: DurationString::new(Duration::from_secs(60 * 60)),
            #[cfg(any(test, feature = "test-util"))]
