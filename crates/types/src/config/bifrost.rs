...
pub struct ReplicatedLogletOptions {
    ...
    #[serde(
        default = "default_log_replication",
        skip_serializing_if = "is_default_log_replication"
    )]
...
fn is_default_log_replication(replication_property: &ReplicationProperty) -> bool {
