...
use restate_serde_util::{ByteCount, DurationString, NonZeroByteCount, NonZeroDurationString};
...
pub struct BifrostOptions {
    ...
    pub seal_retry_interval: NonZeroDurationString,
...
impl Default for BifrostOptions {
    fn default() -> Self {
        Self {
            ...
            append_retry_min_interval: DurationString::new_unchecked(Duration::from_millis(10)),
            append_retry_max_interval: DurationString::new_unchecked(Duration::from_secs(1)),
            auto_recovery_interval: DurationString::new_unchecked(Duration::from_secs(15)),
            seal_retry_interval: DurationString::new_unchecked(Duration::from_secs(2)),
...
pub struct LocalLogletOptions {
    ...
    pub writer_batch_commit_duration: DurationString,
}
...
impl Default for LocalLogletOptions {
    fn default() -> Self {
        ...
        Self {
            ...
            writer_batch_commit_duration: DurationString::ZERO,
...
pub struct ReplicatedLogletOptions {
    ...
    pub sequencer_inactivity_timeout: NonZeroDurationString,

    /// Log Server RPC timeout
    ///
    /// Timeout waiting on log server response
    pub log_server_rpc_timeout: NonZeroDurationString,
...
impl Default for ReplicatedLogletOptions {
    fn default() -> Self {
        ...
        Self {
            ...
            sequencer_inactivity_timeout: DurationString::new_unchecked(Duration::from_secs(15)),
            read_batch_size: NonZeroByteCount::new(
                NonZeroUsize::new(32 * 1024).expect("Non zero number"),
            ),
            log_server_rpc_timeout: DurationString::new_unchecked(Duration::from_millis(2000)),
