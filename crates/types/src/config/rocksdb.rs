...
impl RocksDbOptions {
    ...
    pub fn rocksdb_write_buffer_size(&self) -> NonZeroUsize {
        ...
        self.rocksdb_write_buffer_size.unwrap_or_else(|| {
            ...
            // Assuming 128MB for bifrost's metadata cf (2 memtables * 128MB default write buffer size)
            let buffer_size = (all_memtables - 384_000_000) / (num_partitions * 3) as usize;
