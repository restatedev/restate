...
pub struct StorageOptions {
    ...
    /// With default values (window=50000, count=30000), compaction triggers when at least 60%
    /// of keys in any window are tombstones. A count larger than the window can never be reached
    /// and disables the sliding-window trigger.
    ///
    /// Default is 30000
    #[cfg_attr(feature = "schemars", schemars(skip))]
    #[serde(
