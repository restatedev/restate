...
#[cfg_attr(feature = "schemars", derive(schemars::JsonSchema))]
#[cfg_attr(feature = "schemars", schemars(rename = "DurabilityMode"))]
#[serde(rename_all = "kebab-case")]
pub enum DurabilityMode {
    ...
    //
    // [Requires node-to-on-node sharing of ad-hoc snapshots] so it's commented until support is
    // added
    ...
    ///
    /// Do not trim unless all replicas are durably include this Lsn.
    ///
