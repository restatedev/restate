...
pub trait ArcSwapExt<T> {
    ...
    /// is't possible (Updateable trait is not object-safe, and requires mut to load()).
    ...
    /// exclusive reference. This should be the preferred method for accessible the updateable, but
