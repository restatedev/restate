...
fn deployment_limits_round_trip_and_update() {
    ...
    add_req.discovery_response.limits = Some(endpoint_manifest::EndpointLimits { invocations: 42 });
    ...
    update_request.discovery_response.limits =
        Some(endpoint_manifest::EndpointLimits { invocations: 100 });
    ...
    update_req.discovery_response.limits =
        Some(endpoint_manifest::EndpointLimits { invocations: 7 });
