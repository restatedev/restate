...
//! those RPCs can be (de)serialized from and to the wire format of the fat RPC as well via [`PartitionProcessorRpc::into_legacy_wire`] and [`PartitionProcessorRpc::from_legacy_wire`].
