...
pub enum Keys {
    ...
    /// of the KeyMatcher they use.
    #[default]
    None,
    /// Matches an exact key
    Single(u64),
    /// Matches any of the two keys (OR)
    Pair(u64, u64),
    /// Matches a key within the inclusive range
...
pub enum KeyFilter {
    ...
    // Matches any record
    Any,
    // Match records that has a specific key
    Include(u64),
    // Match records that has _any_ keys falling within this inclusive range
