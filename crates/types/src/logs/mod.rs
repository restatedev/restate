...
pub struct Header {
    ...
    pub custom_timestamp: Option<MillisSinceEpoch>,
}
...
impl Payload {
    ...
    /// Sets the custom timestamp field on the record header
    pub fn with_custom_timestamp(mut self, ts: MillisSinceEpoch) -> Self {
        self.header.custom_timestamp = Some(ts);
        self
    }
