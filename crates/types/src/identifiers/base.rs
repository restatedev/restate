...
/// It is byte-aligned and ordered lexicographically by those fields.
/// [`CanonicalEntryId`] inserts its sequence between the partition key and kind;
/// projecting it to a base ID reconstructs this layout by value.
///
