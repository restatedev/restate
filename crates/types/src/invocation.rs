...
use crate::identifiers::{
    CommandIndex, IdempotencyId, InvocationId, PartitionKey, PartitionProcessorRpcRequestId,
...
impl ServiceInvocationResponseSink {
    pub fn partition_processor(caller: InvocationId, entry_index: CommandIndex) -> Self {
