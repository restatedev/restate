...
impl PartitionTable {
    ...
    pub fn placement_strategy(&self) -> &Option<ReplicationProperty> {
...
impl PartitionTableBuilder {
    ...
    pub fn set_placement_strategy(&mut self, placement_strategy: Option<ReplicationProperty>) {
        if self.inner.placement_strategy != placement_strategy {
            self.inner.placement_strategy = placement_strategy;
            self.modified = true;
        }
    }

    pub fn placement_strategy(&self) -> &Option<ReplicationProperty> {
        &self.inner.placement_strategy
    }
...
impl TryFrom<PartitionTableShadow> for PartitionTable {
    ...
    fn try_from(value: PartitionTableShadow) -> Result<Self, Self::Error> {
        ...
        builder.set_placement_strategy(value.placement_strategy);
