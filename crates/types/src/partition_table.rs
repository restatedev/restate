...
pub struct LegacyKeyRange {
    pub from: PartitionKey,
    pub to: PartitionKey,
}

impl From<LegacyKeyRange> for crate::sharding::KeyRange {
    fn from(val: LegacyKeyRange) -> Self {
        crate::sharding::KeyRange::new(val.from, val.to)
    }
}
