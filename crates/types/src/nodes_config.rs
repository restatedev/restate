...
pub enum ClusterFeature {
    ...
    Unknown,
    /// Routes idempotent invocations on unscoped services to a bounded, per-service
    ...
    /// set of 255 partition-key buckets, and an idempotent invocation is routed to
    ...
    /// been accepted under a given bucketing scheme, switching schemes would
