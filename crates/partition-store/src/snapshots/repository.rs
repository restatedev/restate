    ...
    pub fn get_age(&self) -> Result<Duration, SystemTimeError> {
        match self {
            ...
            ArchivedLsn::Snapshot {
                latest_snapshot_created_at: created_at,
                ..
...
impl SnapshotRepository {
    ...
    /// Retrieve the archived LSN from the snapshot repository
    ///
    /// LSN of the earliest point in the log that is safely persisted to object storage.
