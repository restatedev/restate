...
impl KeyKind {
    ...
    pub const fn as_bytes(&self) -> &'static [u8; Self::SERIALIZED_LENGTH] {
        ...
        match self {
            ...
            KeyKind::ArchivedInvocationStatus => b"iA",
            ...
            KeyKind::ArchivedJournalV2 => b"jA",
            KeyKind::Outbox => b"ob",
    ...
    pub const fn from_bytes(bytes: &[u8; Self::SERIALIZED_LENGTH]) -> Option<Self> {
        match bytes {
            ...
            b"iA" => Some(KeyKind::ArchivedInvocationStatus),
            b"jo" => Some(KeyKind::Journal),
            b"j2" => Some(KeyKind::JournalV2),
            b"jA" => Some(KeyKind::ArchivedJournalV2),
