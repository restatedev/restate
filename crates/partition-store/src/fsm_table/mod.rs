...
use restate_storage_api::fsm_table::{
    PartitionDurability, ReadFsmTable, SequenceNumber, StoredPartitionConfigState, WriteFsmTable,
};
...
impl ReadFsmTable for PartitionStore {
    ...
    async fn get_partition_config_state(&mut self) -> Result<Option<StoredPartitionConfigState>> {
