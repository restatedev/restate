...
use restate_storage_api::partition_store::protobuf_types::PartitionStoreProtobufValue;
...
mod tests {
    ...
    use super::*;
    use restate_storage_api::partition_store::protobuf_types::ProtobufStorageWrapper;
