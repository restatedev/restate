...
impl<const CAN_BE_ZERO: bool> From<NonZeroUsize> for ByteCount<CAN_BE_ZERO> {
...
impl<'de, const CAN_BE_ZERO: bool> DeserializeAs<'de, u64> for ByteCount<CAN_BE_ZERO> {
...
impl<const CAN_BE_ZERO: bool> SerializeAs<usize> for ByteCount<CAN_BE_ZERO> {
...
impl<'de, const CAN_BE_ZERO: bool> DeserializeAs<'de, usize> for ByteCount<CAN_BE_ZERO> {
...
impl SerializeAs<NonZeroUsize> for ByteCount<false> {
    ...
    where
        S: serde::Serializer,
    {
        Self::new(*source).serialize(serializer)
    }
}
