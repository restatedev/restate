...
pub struct ConnectionConfig {
    ...
    // caps remote peer's max-concurrent-streams
    cap_max_send_streams: usize,
        ...
        loop {
            match this.state {
                ...
                ResponseFutureState::Driving { ref mut fut } => {
                    ...
                    // value — that's fine, every later `poll_ready()` re-runs
                    // this resize.
                    //
