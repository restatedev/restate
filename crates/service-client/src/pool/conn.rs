...
use crate::pool::metric_definitions::{
    CONNECTION_POOL_CONNECTION_CLOSED, CONNECTION_POOL_CONNECTION_OPEN_FAILED,
    CONNECTION_POOL_CONNECTION_OPENED, CONNECTION_POOL_STREAM_CLOSED,
    CONNECTION_POOL_STREAM_DURATION, CONNECTION_POOL_STREAM_OPEN_FAILED,
