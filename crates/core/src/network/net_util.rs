...
/// RandomAddressResolver is adapted from the default GaiResolver used in hyper_util, but instead of returning
/// the full list of resolved ips in the order from getaddressinfo, we choose a single random ipv4 and ipv6.
