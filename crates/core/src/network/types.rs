...
use restate_types::net::{AdvertisedAddress, ProtocolVersion, RpcResponse, WatchResponse};
...
pub struct SubscriptionRx<O: WatchResponse> {
    protocol_version: ProtocolVersion,
    inner: mpsc::Receiver<RawSubscriptionReply>,
    _marker: PhantomData<O>,
}

impl<O: WatchResponse> SubscriptionRx<O> {
