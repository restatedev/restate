...
impl V1Compat {
    ...
    pub(super) fn new(v1_target: net::ServiceTag, body: &Bytes) -> Self {
        use net::ServiceTag::*;
        match v1_target {
            Unknown
            | LogServerDataService
            | LogServerMetaService
            | SequencerDataService
            | SequencerMetaService
            | GossipService
            ...
            LogServerSeal => {
                ...
                .expect("deserialization infallible");
                Self::Rpc {
                    v2_service: LogServerMetaService,
            ...
            ReplicatedLogletAppend => {
                ...
                Self::Rpc {
                    v2_service: SequencerDataService,
    ...
    pub(super) fn translate_v2_tag_to_v1_target(
        ...
        match tag {
            ...
            LogServerMetaService => match msg_type {
            ...
            SequencerDataService => match msg_type {
                net::replicated_loglet::Append::TYPE => Some(ReplicatedLogletAppend),
                _ => None,
            },
            SequencerMetaService => match msg_type {
