...
pub mod cluster_ctrl_svc {
    ...
    pub fn new_cluster_ctrl_client<O: CommonClientConnectionOptions>(
        ...
        cluster_ctrl_svc_client::ClusterCtrlSvcClient::new(channel)
            .max_encoding_message_size(connection_options.max_encoding_message_size())
            .max_decoding_message_size(connection_options.max_decoding_message_size())
...
pub mod node_ctl_svc {
    ...
    pub fn new_node_ctl_client<O: CommonClientConnectionOptions>(
        channel: Channel,
        connection_options: &O,
