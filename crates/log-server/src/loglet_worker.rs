...
pub struct LogletWorkerHandle {
    ...
    info_svc_tx: mpsc::UnboundedSender<ServiceMessage<LogServerInfoService>>,
...
impl LogletWorkerHandle {
    ...
    pub fn enqueue_info_msg(&self, op: ServiceMessage<LogServerInfoService>) {
...
impl<S: LogStore> LogletWorker<S> {
    ...
    async fn run(
        ...
        mut info_svc_rx: mpsc::UnboundedReceiver<ServiceMessage<LogServerInfoService>>,
    ) {
    ...
    async fn process_info_svc_op(
        &mut self,
        msg: ServiceMessage<LogServerInfoService>,
