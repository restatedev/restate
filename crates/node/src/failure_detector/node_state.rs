...
impl Node {
    ...
    pub fn maybe_update_state(
        ...
        // 2. It's reporting that it's been lonely (not processing gossips) for too long
    ...
    pub fn send_gossip(
        ...
        let connection = self.connection.get_or_insert_with(|| {
        ...
        connection.try_send_unary(msg, None)
    }
}
