...
impl Node {
    pub async fn create(
        ...
        // The Worker (if present) will set its partition locator and register
        // partition-based scanners into it. The RemoteQueryScannerServer below
        // serves scan RPCs for all registered scanners regardless of role.
