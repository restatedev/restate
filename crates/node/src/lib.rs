...
impl Node {
    ...
    async fn attach_node(
        ...
        info!("Attaching to cluster controller at '{cluster_controller_address}'");
        ...
        // todo: resolve name to id from attachment result, or create.
        let node_id = NodeId::new_plain(1);
        ...
        let my_node_id: NodeId = node_id.with_generation(now.as_u64() as u32).into();
        ...
        let address: NetworkAddress =
            NetworkAddress::TcpSocketAddr(options.server.bind_address.into());
