...
pub(crate) fn wrap_outbox_message_in_envelope(
    ...
    let dedup = create_header(seq_number, shuffle_metadata);
...
fn create_header(seq_number: MessageIndex, shuffle_metadata: &ShuffleMetadata) -> Dedup {
    ...
    OR: OutboxReader + Send + Sync + 'static,
{
    ...
    pub fn create_hint_sender(&self) -> HintSender {
