...
mod tests {
    ...
    fn assert_reply(decision: Decision, expected: ResumeInvocationRpcResponse) {
        let Decision::Reply(Ok(actual)) = decision else {
    ...
    async fn reply_not_found_for_unknown_invocation() {
        ...
        .await;
        assert_reply(decision, ResumeInvocationRpcResponse::NotFound);
    }
    ...
    async fn reply_completed() {
        ...
        .await;
        assert_reply(decision, ResumeInvocationRpcResponse::Completed);
    }
    ...
    async fn reply_not_started(
        ...
        .await;
        assert_reply(decision, ResumeInvocationRpcResponse::NotStarted);
    }
