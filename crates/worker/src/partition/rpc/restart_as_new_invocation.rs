...
mod tests {
    ...
    async fn copy_prefix_zero_with_no_version_uses_service_invocation_command() {
        ...
        proposer
            .expect_handle_rpc_proposal_command::<commands::InvokeCommand, RestartAsNewInvocationRpcResponse>()
            .never();
    ...
    async fn old_workaround_nonzero_prefix_is_unsupported() {
        ...
        proposer
            ...
            .never();
        proposer
            .expect_handle_rpc_proposal_command::<commands::RestartAsNewInvocationCommand, RestartAsNewInvocationRpcResponse>()
            .never();
