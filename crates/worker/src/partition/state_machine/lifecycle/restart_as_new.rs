...
mod tests {
    ...
    async fn restart_missing_journal() {
        ...
        let actions = test_env
            .apply(records::RestartAsNewInvocation::test_envelope(
    ...
    async fn restart_killed_invocation() {
        ...
        let _ = test_env
            .apply_multiple([
                ...
                records::TerminateInvocation::test_envelope(InvocationTermination {
                    invocation_id: original_invocation_id,
    ...
    async fn restart_copies_journal_prefix() {
        ...
        let _ = test_env
            .apply_multiple([
                ...
                records::NotifySignal::test_envelope(NotifySignalRequest {
                    invocation_id: original_invocation_id,
                    signal: Signal::new(
                ...
                records::Timer::test_envelope(TimerKeyValue::complete_journal_entry(
                    wake_up_time,
                    original_invocation_id,
                    completion_id,
                )),
