...
impl InvocationStatusExt for InvocationStatus {
    fn should_accept_completion(
        ...
        if let Some(im) = self.get_invocation_metadata() {
            // We should accept completions for commands we haven't truncated.
            ...
            // it means this completion instance was generated by a command that is **after** the truncation point,
            // thus it should be truncated.
            //
...
mod tests {
    ...
    fn trim_at_2() {
        ...
        // I truncate with completion id 2 and bump invocation epoch from 0 to 1
        let mut completion_range_epoch_map = CompletionRangeEpochMap::default();
        completion_range_epoch_map.add_truncation_point(2, 1);
