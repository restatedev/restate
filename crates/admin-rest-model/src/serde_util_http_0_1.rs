...
// TODO this file is a copy paste of what's in the serde-util module, but this is linked against http 0.1
//  remove once we convert admin and admin-rest-model to hyper 1.0/http 0.1
