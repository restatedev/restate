...
impl RocksDbPerfGuard {
    /// IMPORTANT NOTE: you MUST bind this value with a named variable (do not use `_`) to ensure
...
impl Drop for RocksDbPerfGuard {
    fn drop(&mut self) {
        ...
        ROCKSDB_PERF_CONTEXT.with(|context| {
            // Note to future visitors of this code. RocksDb report times in nanoseconds in this
