...
struct JournalTracker {
    ...
    acked_notifications_from_partition_processor: HashSet<NotificationId>,
...
impl JournalTracker {
    ...
    fn notify_acked_notification_from_partition_processor(&mut self, id: NotificationId) {
        self.acked_notifications_from_partition_processor.insert(id);
    }
    ...
    fn can_retry(&self) -> bool {
        ...
        let notifications_condition = self
            ...
            .is_subset(&self.acked_notifications_from_partition_processor);
