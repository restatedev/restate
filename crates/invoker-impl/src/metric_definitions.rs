...
pub const INVOKER_HTTP_SENT_BYTES: &str = "restate.invoker.http.sent.bytes.total";
pub const INVOKER_HTTP_RECEIVED_BYTES: &str = "restate.invoker.http.received.bytes.total";
pub const INVOKER_HTTP_CLIENT_REQUESTS: &str = "restate.invoker.http.client_requests.total";
