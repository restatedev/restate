...
/// Which directional budget was exhausted.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(crate) enum BudgetDirection {
    Inbound,
    Outbound,
}

impl fmt::Display for BudgetDirection {
...
impl InvokerError {
    ...
    /// [`InvokerError::BudgetExhausted`] with [`BudgetDirection::Outbound`].
