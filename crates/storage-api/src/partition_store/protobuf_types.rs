...
impl PartitionStoreProtobufValue for SemanticRestateVersion {
    type ProtobufType = crate::partition_store::protobuf_types::v1::RestateVersion;
}
...
pub mod v1 {
    ...
    pub mod pb_conversion {
        ...
        use crate::partition_store::protobuf_types::ConversionError;
        use crate::partition_store::protobuf_types::v1::dedup_sequence_number::Variant;
        use crate::partition_store::protobuf_types::v1::enriched_entry_header::{
        ...
        use crate::partition_store::protobuf_types::v1::entry::EntryType;
        use crate::partition_store::protobuf_types::v1::invocation_status::{
        ...
        use crate::partition_store::protobuf_types::v1::journal_entry::completion_result::{
            Empty, Failure, Success,
        };
        use crate::partition_store::protobuf_types::v1::journal_entry::{
            CompletionResult, Kind, completion_result,
        };
        use crate::partition_store::protobuf_types::v1::outbox_message::{
            NotifySignal, OutboxCancel, OutboxKill, OutboxServiceInvocation,
            OutboxServiceInvocationResponse,
        };
        use crate::partition_store::protobuf_types::v1::service_invocation_response_sink::{
            Ingress, PartitionProcessor, ResponseSink,
        };
        use crate::partition_store::protobuf_types::v1::{
