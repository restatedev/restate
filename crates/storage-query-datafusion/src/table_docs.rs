...
use crate::{
    deployment, inbox, invocation_index, invocation_state, invocation_status, journal,
    journal_events, promise, rules, scheduler_status, service, state, stats, user_limits,
...
pub const ALL_TABLE_DOCS: &[StaticTableDocs] = &[
    invocation_index::schema::TABLE_DOCS,
