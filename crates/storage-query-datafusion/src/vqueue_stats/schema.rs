...
define_table!(sys_vqueue_stats(
    ...
    last_completion_at: TimestampMillisecond,

    /// Exponential moving average (EMA) of first-attempt queue wait time.
    avg_queue_duration: DataType::Duration,

    /// Exponential moving average (EMA) of how long entries stay in Inbox before transitioning out.
    avg_inbox_duration: DataType::Duration,

    /// Exponential moving average (EMA) of how long entries stay in Run before transitioning out.
    avg_run_duration: DataType::Duration,

    /// Exponential moving average (EMA) of how long entries stay in Park before transitioning out.
    avg_park_duration: DataType::Duration,
    ...
    /// The number of entries that are paused or suspended.
    num_parked: DataType::UInt64,
